...
4. predFA.R: codes to perform genomic prediction within environments. Out of curiosity, it took ~8 days to be completed in 32 Intel(R) Xeon(R) Gold 6152 CPU @2.10GHz processors with ~120 Gb of RAM memory.
